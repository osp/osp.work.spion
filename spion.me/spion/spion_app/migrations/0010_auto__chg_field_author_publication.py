...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Author.publication'
        db.alter_column('spion_app_author', 'publication_id', self.gf('adminsortable.fields.SortableForeignKey')(to=orm['spion_app.Publication'], null=True))

    def backwards(self, orm):

        # Changing field 'Author.publication'
        db.alter_column('spion_app_author', 'publication_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spion_app.Publication'], null=True))
    ...
    models = {
        ...
        'spion_app.author': {
            ...
            'publication': ('adminsortable.fields.SortableForeignKey', [], {'to': "orm['spion_app.Publication']", 'null': 'True', 'blank': 'True'}),
