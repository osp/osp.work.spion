...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('spion_app_userprofile', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='foo', max_length=255),
                      keep_default=False)

        # Adding field 'NewsItem.slug'
        db.add_column('spion_app_newsitem', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='foo', max_length=255),
                      keep_default=False)

        # Adding field 'Publication.slug'
        db.add_column('spion_app_publication', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='foo', max_length=255),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('spion_app_userprofile', 'slug')

        # Deleting field 'NewsItem.slug'
        db.delete_column('spion_app_newsitem', 'slug')

        # Deleting field 'Publication.slug'
        db.delete_column('spion_app_publication', 'slug')
    ...
    models = {
        ...
        'spion_app.publication': {
            ...
            'external_authors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'publications'", 'symmetrical': 'False', 'to': "orm['spion_app.ExternalAuthor']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
