...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PublicationType.sort_order'
        db.add_column('spion_app_publicationtype', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=1, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PublicationType.sort_order'
        db.delete_column('spion_app_publicationtype', 'sort_order')
