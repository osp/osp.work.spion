...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('spion_app_partner', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'SpionProject.title'
        db.add_column('spion_app_spionproject', 'title',
                      self.gf('django.db.models.fields.CharField')(default='box title', max_length=512),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partner.description'
        db.delete_column('spion_app_partner', 'description')

        # Deleting field 'SpionProject.title'
        db.delete_column('spion_app_spionproject', 'title')
